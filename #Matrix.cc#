...
Matrix::Matrix(int w, int h) {
  std::cout << "  Matrix::Matrix(int w, int h)"
            << std::endl;
  width = w;
  height = h;
...
Matrix::Matrix(const Matrix &m) {
  std::cout << "  Matrix::Matrix(cosnt Matrix &m)"
            << std::endl;
  width = m.width;
  height = m.height;
  data = new double[width * height];
...
Matrix &Matrix::operator = (const Matrix &m) {
  std::cout << "  Matrix &Matrix::operator = (const Matrix &m)"
            << std::endl;
  if (&m != this) {
    delete[] data;
    width = m.width;
...
bool Matrix::operator == (const Matrix &m) const {
  std::cout << "  bool Matrix::operator == (const Matrix &m) const"
            << std::endl;
...
Matrix Matrix::operator + (const Matrix &m) const {
  std::cout << "  Matrix Matrix::operator + (const Matrix &m) const"
            << std::endl;
  if (width != m.width || height != m.height) {
...
double &Matrix::operator () (int i, int j) {
  std::cout << "  double &Matrix::operator () (int i, int j)"
            << std::endl;
